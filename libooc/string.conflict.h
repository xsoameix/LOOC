...
#define O_String_OVERRIDE_METHOD_3 hash_code, ooc_uint
#define O_String_OVERRIDE_METHOD_4 inspect, char *
#define O_String_PUBLIC_METHOD_0 set, void, (char * chars, chars)
#define O_String_PUBLIC_METHOD_1 index, ooc_uint, (bool (* func)(void * _self_, char c), func), (void * _self_, _self_)
#define O_String_PUBLIC_METHOD_2 rindex, ooc_uint, (bool (* func)(void * _self_, char c), func), (void * _self_, _self_)
